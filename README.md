...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/badger-opt-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14416&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/badger-opt-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `badger-opt` can be installed with:

```
conda install badger-opt
```

It is possible to list all of the versions of `badger-opt` available on your platform with:
